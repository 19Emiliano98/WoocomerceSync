...
try {
    ...
    // Buscar IDs en WooCommerce — UNA sola llamada con todos los SKUs
    $batchUpdate = [];
    $notInWoo    = [];
    $skuToData   = [];
    ...
    // WooCommerce acepta ?sku=A,B,C con hasta 100 SKUs
    ...
    try {
        ...
        // Si falla la búsqueda en lote, marcar todos como not_in_woo
